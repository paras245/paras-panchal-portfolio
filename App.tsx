    ...
    <div className={`min-h-screen selection:bg-[#D4AF37] selection:text-black ${isRtl ? 'font-arabic' : 'font-english'}`} dir={isRtl ? 'rtl' : 'ltr'}>
             ...
             >
                ...
                <div className="w-full md:w-1/2 relative group">
                  <motion.div 
                    ...
                    className="relative overflow-hidden rounded-xl border border-white/10 shadow-2xl bg-white/5 perspective-1000"
                  >
                    <img 
                      src="https://media.licdn.com/dms/image/v2/D4D2DAQG8-g-g-g-g-g/single-media-viewer-thumbnail/0/1715423851023?e=1716028800&v=beta&t=H-H-H-H-H" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
                      <span className="text-white text-[10px] uppercase tracking-widest font-bold">LinkedIn Learning | Microsoft Azure AI</span>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="w-full md:w-1/2 text-center md:text-left">
                   ...
                   <h3 className="text-3xl md:text-5xl font-black text-white mb-6 leading-tight mobile-text-wrap">Azure AI Essentials Certified</h3>
                   <p className="text-gray-400 text-sm md:text-base leading-relaxed mb-8 font-light">
                      Validated by LinkedIn Learning & Microsoft for expertise in Azure AI Foundry, Machine Learning Workloads, and modern Gen-AI operations.
                   </p>
                   <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-10">
                      {["Machine Learning", "Azure AI Foundry", "Gen-AI"].map((tag) => (
                   ...
                   <a 
                    ...
                    target="_blank" 
                    className="inline-flex items-center gap-4 px-10 py-4 bg-[#D4AF37] text-black font-bold uppercase tracking-[0.2em] text-[10px] hover:bg-[#F9E79F] transition-all transform hover:-translate-y-1 shadow-lg shadow-[#D4AF37]/20"
                   >
      ...
      <footer className="py-20 border-t border-[#D4AF37]/10 bg-black text-center">
        <div className="container mx-auto px-6">
          <p className="text-[#D4AF37]/60 text-sm tracking-widest mb-6">PARAS PANCHAL &copy; 2024</p>
